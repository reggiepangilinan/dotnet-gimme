...
namespace gimme.Commands.WebApiStarter
{
    ...
    public partial class Command
    {
        private void Step02_CreateProjects()
        {
            ...
            Console.WriteLine(shellService.Exec($"dotnet new classlib -n {variable.PersistenceProjectName} -o {SolutionName}/{variable.PersistenceProjectName} -f netcoreapp2.1"));
