...
namespace gimme.Commands.WebApiStarter
{
    public class VariableGenerator
    {
        ...
        public string ServicesUnitTestProjectName => $"{solutionName}.ServicesUnitTest";
        ...
        public string CSPROJ_ServicesUnitTestProjectFile => $"{SolutionName}/{ServicesUnitTestProjectName}/{ServicesUnitTestProjectName}.csproj";
